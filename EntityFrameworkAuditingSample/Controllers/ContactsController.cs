...
namespace EntityFrameworkAuditingSample.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,FirstName,LastName,ContactNumber")] Contact contact)
        {
